...
import useData from "./contextApi"
  ...
  export default function Cart() {
    const {globaldata,setglobaldata,loginDetails} = useData()
    ...
    useEffect(()=>{
       ...
       try {
        const products = await axios.post('http://localhost:3000/api/products-data/cart-products',{username : loginDetails,pageNo})
      ...
      alert('error in sending request sing axios')
        ...
        alert('you must login to access cart page')
        navigate('/login')
       }
    },[moreProducts])
