...
>
        {!shuffleform && <div className="flex flex-col w-[40%] h-auto rounded-xl mx-auto  bg-[black] ">
            ...
            <input type="file" className="border-orange-500 border-2 mx-[20%] w-[60%] h-[40px] rounded"   />
            <button className="text-white bg-orange-500 rounded px-5 py-2 mx-[40%] my-3 border-orange-500 border-2  ">Submit</button>
