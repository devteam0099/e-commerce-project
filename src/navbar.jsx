...
function Navbar(){
    ...
    return(
        ...
        <div className=" h-full w-full flex justify-between ">
            <div className="md:basis-[30%] mt-2 mx-10 hidden md:block">
                <input placeholder="Search Here " className="border-[orange] hidden md:block border-2 w-[80%] h-12 rounded-xl" />
                
           </div>

            <div className=" md:basis-[70%] basis-[100%] flex justify-around mt-2">
               ...
               <div className="text-center">
                ...
                <FontAwesomeIcon icon={faList} className="text-[orange] text-3xl mt-2  " />
       ...
       {shownav && <div className=" w-[full] text-center border-[black] border-8 bg-[black]  text-white text-xl flex flex-col  justify-between  ">
            <div  style={{borderBottom: "1px solid gray"}} className="p-2 text-center">
                <FontAwesomeIcon icon={faUser} className="text-[orange]" />
                <span onClick={shownavigation} className="mx-[20%]"><NavLink to="/login" className={({ isActive }) => (isActive ? "text-orange-500" : "")}>Login</NavLink></span>
            </div>
            <div  style={{borderBottom: "1px solid gray"}} className="p-2 ">
                <FontAwesomeIcon icon={faPhone} className="text-[orange]" />
                <span onClick={shownavigation} className="mx-10"><NavLink to="/contact-us" className={({ isActive }) => (isActive ? "text-orange-500" : "")}>Contact US</NavLink></span>
                
            </div>
            <div  style={{borderBottom: "1px solid gray"}} className="p-2">
                <FontAwesomeIcon icon={faUsersCog} className="text-[orange]" />
                <span onClick={shownavigation} className="mx-[15%]"><NavLink to="/about-us" className={({ isActive }) => (isActive ? "text-orange-500" : "")}>About Us</NavLink></span>
            </div>
            <div  style={{borderBottom: "1px solid gray"}} className="p-2" >
                <FontAwesomeIcon icon={faPlus} className="text-[orange]" />
                <span onClick={shownavigation} className="mx-[11%]"><NavLink to="/add-items" className={({ isActive }) => (isActive ? "text-orange-500" : "")}>Add Product</NavLink></span>
            </div>
        </div>}
        </nav>
        </>
